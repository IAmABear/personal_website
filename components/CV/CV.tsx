...
const CV = () => (
  ...
  >
    ...
    >
      <h2 className="text-2xl mt-16 italic">Curriculum Vitae</h2>

      <section className="md:max-w-lg lg:max-w-3xl p-8 m-4 bg-gray-800 md:p-16">
        <h3 className="text-2xl text-center mb-4">Profile</h3>
      ...
      <section className="w-full md:max-w-lg lg:max-w-3xl p-4 m-4 md:pb-16">
        <h3 className="text-2xl text-center mb-4">Skills</h3>
        <Skills />
      </section>
    </span>
  </div>

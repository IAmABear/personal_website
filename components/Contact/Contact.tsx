  ...
  <div className="p-2 md:p-8 bg-blue-900" id="contact">
    <div className="flex flex-col justify-center items-center divide-y divide-white md:flex-row md:divide-y-0 md:divide-x">
      <a
        ...
        className="font-sans py-2 font-normal text-white md:px-4 md:py-0 hover:underline font-serif"
      >
        {phoneNumber}
      </a>
      ...
      <p className="font-sans py-2 font-normal text-white md:px-4 md:py-0 font-serif">
        {residency}
      </p>
    </div>
  </div>
